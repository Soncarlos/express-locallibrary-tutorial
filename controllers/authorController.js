...
// Mostrar el registro recien Creado desde el formulario create
...
exports.author_update_post = [
  body("first_name", "First Name must not be empty")
    ...
    .withMessage("First name has non-alphanumeric characters.")
    .escape(),
  body("family_name", "Family_name must not be empty")
    .trim()
    .isLength({ min: 1 })
    .isAlphanumeric()
    .withMessage("Family_name has non-alphanumeric Characters.")
    .escape(),
  body("date_of_birth", " Invalid Date of Birth")
    .optional({ checkFalsy: "true" })
    .isISO8601()
